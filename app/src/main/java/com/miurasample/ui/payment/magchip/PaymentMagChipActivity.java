...
public class PaymentMagChipActivity extends BaseActivity implements BaseTransactionView {

    private PaymentMagChipPresenter presenter;
    private ViewHolder viewHolder;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_payment_magchip);
        viewHolder = new ViewHolder(this);
        setUpToolbar("Payment mag and chip", true);
        presenterSetUp();
        cancelBtn();
    }
    ...
    protected void presenterSetUp() {
        ...
        if (startInfo != null) {
            presenter = new PaymentMagChipPresenter(this, startInfo);
            presenter.onLoad();
        } else {
    ...
    static class ViewHolder {
        ...
        @Bind(R.id.payment_magchip_tv_text)
        TextView tvText;
